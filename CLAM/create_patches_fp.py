# internal imports
from wsi_core.WholeSlideImage_v2 import WholeSlideImage
...
if __name__ == '__main__':
	...
	seg_params = {'seg_level': -1, 'sthresh': 8, 'mthresh': 7, 'close': 4, 'use_otsu':True,# False,
				  'keep_ids': 'none', 'exclude_ids': 'none'}
	# seg_params = {'seg_level': 0, 'sthresh': 8, 'mthresh': 7, 'close': 4, 'use_otsu':True,# False,
	# 			  'keep_ids': 'none', 'exclude_ids': 'none'}
	# filter_params = {'a_t':100, 'a_h': 16, 'max_n_holes':8}
	filter_params = {'a_t': 3, 'a_h': 8, 'max_n_holes': 100}
	# filter_params = {'a_t':100, 'a_h': 16, 'max_n_holes':8}
