...
# TODO: try out the new mutli prefix training, make criterion an arg in train
...
class EmbeddingDataset(Dataset):
    def __init__(self, dataset_csv: str, zip_path: str, split: str = 'train', label_prefix=None, z_score=False, processor=None):
        ...
        # Rename to get to common keys. eg 'CoReBT-0033-mri_embedding' goes to 'CoReBT-0033'
        for embed_key in list(self.embeds.keys()): 
            subject_id= embed_key.split('-mri')[0]
            self.embeds[subject_id] = self.embeds.pop(embed_key)
        ...
        self.samples = self.split_df["subject_id"].astype(str).str.strip().tolist()
